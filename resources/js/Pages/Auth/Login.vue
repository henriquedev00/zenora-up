        ...
        <div class="w-full max-w-md bg-white rounded-2xl shadow-xl p-6 sm:p-8 space-y-6">
            ...
            <form method="POST" @submit.prevent="authenticate()" class="space-y-4">
                <div>
                    ...
                    <input type="email" v-model="form.email" name="email" placeholder="seu@email.com" required class="w-full mt-1 px-4 py-3 rounded-xl border border-gray-300 bg-gray-50 focus:ring-2 focus:ring-blue-500 focus:bg-white focus:border-blue-500 focus-visible:outline-blue-500 transition">
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        <input :type="showPassword ? 'text' : 'password'" v-model="form.password" name="password" placeholder="••••••••" required class="w-full mt-1 px-4 py-3 pr-12 rounded-xl border border-gray-300 bg-gray-50 focus:ring-2 focus:ring-blue-500 focus:bg-white focus:border-blue-500 focus-visible:outline-blue-500 transition">
